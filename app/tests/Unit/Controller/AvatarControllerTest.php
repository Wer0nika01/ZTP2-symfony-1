...
class AvatarControllerTest extends TestCase
{
    ...
    public function testCreateActionPostRequestInvalidForm(): void
    {
        ...
        $request = Request::create('/avatar/create', Request::METHOD_POST);
        $this->controller->create($request);
    }
    ...
    public function testEditActionPutRequestInvalidForm(): void
    {
        ...
        $request = Request::create('/avatar/1/edit', Request::METHOD_PUT);
        $this->controller->edit($request, $mockAvatar);
    }
    ...
    public function testDeleteActionInvalidForm(): void
    {
        ...
        $request = Request::create('/avatar/1/delete', Request::METHOD_DELETE);
     ...
     *
     * @param bool $isSubmitted Is submitted
     * @param bool $isValid     Is valid
     *
     * @return MockObject|FormInterface Form interface mock
     */
